...
func (m *AsyncWorkflowMessage) Reset()         { *m = AsyncWorkflowMessage{} }
func (m *AsyncWorkflowMessage) String() string { return proto.CompactTextString(m) }
func (*AsyncWorkflowMessage) ProtoMessage()    {}
func (*AsyncWorkflowMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{88}
}
func (m *AsyncWorkflowMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AsyncWorkflowMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AsyncWorkflowMessage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AsyncWorkflowMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AsyncWorkflowMessage.Merge(m, src)
}
func (m *AsyncWorkflowMessage) XXX_Size() int {
	return m.Size()
}
func (m *AsyncWorkflowMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_AsyncWorkflowMessage.DiscardUnknown(m)
}

var xxx_messageInfo_AsyncWorkflowMessage proto.InternalMessageInfo

func (m *AsyncWorkflowMessage) GetMessageId() int64 {
	if m != nil {
		return m.MessageId
	}
	return 0
...
func (m *AsyncWorkflowMessage) GetPayload() []byte {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (m *AsyncWorkflowMessage) GetEncoding() string {
	if m != nil {
		return m.Encoding
	}
	return ""
...
func (m *AsyncWorkflowMessage) GetPartitionKey() string {
	if m != nil {
...
func (m *AsyncWorkflowMessage) GetCreatedTime() *types.Timestamp {
	if m != nil {
...
func (m *EnqueueAsyncWorkflowMessageRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *GetAsyncWorkflowMessagesRequest) Reset()         { *m = GetAsyncWorkflowMessagesRequest{} }
func (m *GetAsyncWorkflowMessagesRequest) String() string { return proto.CompactTextString(m) }
func (*GetAsyncWorkflowMessagesRequest) ProtoMessage()    {}
func (*GetAsyncWorkflowMessagesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{91}
}
func (m *GetAsyncWorkflowMessagesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetAsyncWorkflowMessagesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetAsyncWorkflowMessagesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetAsyncWorkflowMessagesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetAsyncWorkflowMessagesRequest.Merge(m, src)
}
func (m *GetAsyncWorkflowMessagesRequest) XXX_Size() int {
	return m.Size()
}
func (m *GetAsyncWorkflowMessagesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetAsyncWorkflowMessagesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetAsyncWorkflowMessagesRequest proto.InternalMessageInfo

func (m *GetAsyncWorkflowMessagesRequest) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *GetAsyncWorkflowMessagesRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *GetAsyncWorkflowMessagesRequest) GetLastMessageId() int64 {
	if m != nil {
...
func (m *GetAsyncWorkflowMessagesRequest) GetPageSize() int32 {
	if m != nil {
		return m.PageSize
	}
	return 0
...
type GetAsyncWorkflowMessagesResponse struct {
	Messages             []*AsyncWorkflowMessage `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
...
func (m *GetAsyncWorkflowMessagesResponse) Reset()         { *m = GetAsyncWorkflowMessagesResponse{} }
func (m *GetAsyncWorkflowMessagesResponse) String() string { return proto.CompactTextString(m) }
func (*GetAsyncWorkflowMessagesResponse) ProtoMessage()    {}
func (*GetAsyncWorkflowMessagesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{92}
}
func (m *GetAsyncWorkflowMessagesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetAsyncWorkflowMessagesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetAsyncWorkflowMessagesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetAsyncWorkflowMessagesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetAsyncWorkflowMessagesResponse.Merge(m, src)
}
func (m *GetAsyncWorkflowMessagesResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetAsyncWorkflowMessagesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetAsyncWorkflowMessagesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetAsyncWorkflowMessagesResponse proto.InternalMessageInfo

func (m *GetAsyncWorkflowMessagesResponse) GetMessages() []*AsyncWorkflowMessage {
	if m != nil {
		return m.Messages
	}
	return nil
...
func (m *GetAsyncWorkflowMessagesResponse) GetAckLevel() int64 {
	if m != nil {
		return m.AckLevel
	}
	return 0
...
func (m *UpdateAsyncWorkflowAckLevelRequest) Reset()         { *m = UpdateAsyncWorkflowAckLevelRequest{} }
func (m *UpdateAsyncWorkflowAckLevelRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateAsyncWorkflowAckLevelRequest) ProtoMessage()    {}
func (*UpdateAsyncWorkflowAckLevelRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{93}
}
func (m *UpdateAsyncWorkflowAckLevelRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateAsyncWorkflowAckLevelRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateAsyncWorkflowAckLevelRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateAsyncWorkflowAckLevelRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateAsyncWorkflowAckLevelRequest.Merge(m, src)
}
func (m *UpdateAsyncWorkflowAckLevelRequest) XXX_Size() int {
	return m.Size()
}
func (m *UpdateAsyncWorkflowAckLevelRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateAsyncWorkflowAckLevelRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateAsyncWorkflowAckLevelRequest proto.InternalMessageInfo

func (m *UpdateAsyncWorkflowAckLevelRequest) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *UpdateAsyncWorkflowAckLevelRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *UpdateAsyncWorkflowAckLevelRequest) GetAckLevel() int64 {
	if m != nil {
		return m.AckLevel
	}
	return 0
...
func (m *UpdateAsyncWorkflowAckLevelResponse) Reset()         { *m = UpdateAsyncWorkflowAckLevelResponse{} }
func (m *UpdateAsyncWorkflowAckLevelResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateAsyncWorkflowAckLevelResponse) ProtoMessage()    {}
func (*UpdateAsyncWorkflowAckLevelResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{94}
}
func (m *UpdateAsyncWorkflowAckLevelResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateAsyncWorkflowAckLevelResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateAsyncWorkflowAckLevelResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateAsyncWorkflowAckLevelResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateAsyncWorkflowAckLevelResponse.Merge(m, src)
}
func (m *UpdateAsyncWorkflowAckLevelResponse) XXX_Size() int {
	return m.Size()
}
func (m *UpdateAsyncWorkflowAckLevelResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateAsyncWorkflowAckLevelResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateAsyncWorkflowAckLevelResponse proto.InternalMessageInfo
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) Reset() {
	*m = EnqueueAsyncWorkflowMessageToDLQRequest{}
}
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) String() string { return proto.CompactTextString(m) }
func (*EnqueueAsyncWorkflowMessageToDLQRequest) ProtoMessage()    {}
func (*EnqueueAsyncWorkflowMessageToDLQRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{95}
}
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQRequest.Merge(m, src)
}
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) XXX_Size() int {
	return m.Size()
}
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQRequest.DiscardUnknown(m)
}

var xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQRequest proto.InternalMessageInfo

func (m *EnqueueAsyncWorkflowMessageToDLQRequest) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) GetPayload() []byte {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) GetEncoding() string {
	if m != nil {
		return m.Encoding
	}
	return ""
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) GetPartitionKey() string {
	if m != nil {
		return m.PartitionKey
	}
	return ""
...
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) Reset() {
	*m = EnqueueAsyncWorkflowMessageToDLQResponse{}
}
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) String() string { return proto.CompactTextString(m) }
func (*EnqueueAsyncWorkflowMessageToDLQResponse) ProtoMessage()    {}
func (*EnqueueAsyncWorkflowMessageToDLQResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{96}
}
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQResponse.Merge(m, src)
}
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) XXX_Size() int {
	return m.Size()
}
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQResponse.DiscardUnknown(m)
}

var xxx_messageInfo_EnqueueAsyncWorkflowMessageToDLQResponse proto.InternalMessageInfo

func (m *EnqueueAsyncWorkflowMessageToDLQResponse) GetMessageId() int64 {
	if m != nil {
		return m.MessageId
	}
	return 0
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) Reset() {
	*m = ReadAsyncWorkflowMessagesFromDLQRequest{}
}
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) String() string { return proto.CompactTextString(m) }
func (*ReadAsyncWorkflowMessagesFromDLQRequest) ProtoMessage()    {}
func (*ReadAsyncWorkflowMessagesFromDLQRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{97}
}
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQRequest.Merge(m, src)
}
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) XXX_Size() int {
	return m.Size()
}
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQRequest proto.InternalMessageInfo

func (m *ReadAsyncWorkflowMessagesFromDLQRequest) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) GetLastMessageId() int64 {
	if m != nil {
		return m.LastMessageId
	}
	return 0
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) GetPageSize() int32 {
	if m != nil {
		return m.PageSize
	}
	return 0
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) Reset() {
	*m = ReadAsyncWorkflowMessagesFromDLQResponse{}
}
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) String() string { return proto.CompactTextString(m) }
func (*ReadAsyncWorkflowMessagesFromDLQResponse) ProtoMessage()    {}
func (*ReadAsyncWorkflowMessagesFromDLQResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{98}
}
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQResponse.Merge(m, src)
}
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) XXX_Size() int {
	return m.Size()
}
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ReadAsyncWorkflowMessagesFromDLQResponse proto.InternalMessageInfo

func (m *ReadAsyncWorkflowMessagesFromDLQResponse) GetMessages() []*AsyncWorkflowMessage {
	if m != nil {
		return m.Messages
	}
	return nil
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) GetLastMessageId() int64 {
	if m != nil {
		return m.LastMessageId
	}
	return 0
...
type MergeAsyncWorkflowMessagesFromDLQRequest struct {
	ShardId               int32    `protobuf:"varint,1,opt,name=shard_id,json=shardId,proto3" json:"shard_id,omitempty"`
	QueueName             string   `protobuf:"bytes,2,opt,name=queue_name,json=queueName,proto3" json:"queue_name,omitempty"`
	InclusiveEndMessageId int64    `protobuf:"varint,3,opt,name=inclusive_end_message_id,json=inclusiveEndMessageId,proto3" json:"inclusive_end_message_id,omitempty"`
	PageSize              int32    `protobuf:"varint,4,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) Reset() {
	*m = MergeAsyncWorkflowMessagesFromDLQRequest{}
}
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) String() string { return proto.CompactTextString(m) }
func (*MergeAsyncWorkflowMessagesFromDLQRequest) ProtoMessage()    {}
func (*MergeAsyncWorkflowMessagesFromDLQRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{99}
}
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQRequest.Merge(m, src)
}
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) XXX_Size() int {
	return m.Size()
}
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQRequest proto.InternalMessageInfo

func (m *MergeAsyncWorkflowMessagesFromDLQRequest) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) GetInclusiveEndMessageId() int64 {
	if m != nil {
		return m.InclusiveEndMessageId
	}
	return 0
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) GetPageSize() int32 {
	if m != nil {
		return m.PageSize
	}
	return 0
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) Reset() {
	*m = MergeAsyncWorkflowMessagesFromDLQResponse{}
}
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) String() string {
	return proto.CompactTextString(m)
}
func (*MergeAsyncWorkflowMessagesFromDLQResponse) ProtoMessage() {}
func (*MergeAsyncWorkflowMessagesFromDLQResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{100}
}
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQResponse.Merge(m, src)
}
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) XXX_Size() int {
	return m.Size()
}
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MergeAsyncWorkflowMessagesFromDLQResponse proto.InternalMessageInfo

func (m *MergeAsyncWorkflowMessagesFromDLQResponse) GetMessagesCount() int32 {
	if m != nil {
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) GetLastMessageId() int64 {
	if m != nil {
		return m.LastMessageId
	}
	return 0
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) Reset() {
	*m = PurgeAsyncWorkflowMessagesFromDLQRequest{}
}
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) String() string { return proto.CompactTextString(m) }
func (*PurgeAsyncWorkflowMessagesFromDLQRequest) ProtoMessage()    {}
func (*PurgeAsyncWorkflowMessagesFromDLQRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{101}
}
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQRequest.Merge(m, src)
}
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) XXX_Size() int {
	return m.Size()
}
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQRequest.DiscardUnknown(m)
}

var xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQRequest proto.InternalMessageInfo

func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) GetInclusiveEndMessageId() int64 {
	if m != nil {
		return m.InclusiveEndMessageId
	}
	return 0
...
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) Reset() {
	*m = PurgeAsyncWorkflowMessagesFromDLQResponse{}
}
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) String() string {
	return proto.CompactTextString(m)
}
func (*PurgeAsyncWorkflowMessagesFromDLQResponse) ProtoMessage() {}
func (*PurgeAsyncWorkflowMessagesFromDLQResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fee8ff76963a38ed, []int{102}
}
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQResponse.Merge(m, src)
}
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) XXX_Size() int {
	return m.Size()
}
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQResponse.DiscardUnknown(m)
}

var xxx_messageInfo_PurgeAsyncWorkflowMessagesFromDLQResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AsyncWorkflowMessage)(nil), "uber.cadence.history.v1.AsyncWorkflowMessage")
	...
	proto.RegisterType((*GetAsyncWorkflowMessagesRequest)(nil), "uber.cadence.history.v1.GetAsyncWorkflowMessagesRequest")
	proto.RegisterType((*GetAsyncWorkflowMessagesResponse)(nil), "uber.cadence.history.v1.GetAsyncWorkflowMessagesResponse")
	proto.RegisterType((*UpdateAsyncWorkflowAckLevelRequest)(nil), "uber.cadence.history.v1.UpdateAsyncWorkflowAckLevelRequest")
	proto.RegisterType((*UpdateAsyncWorkflowAckLevelResponse)(nil), "uber.cadence.history.v1.UpdateAsyncWorkflowAckLevelResponse")
	proto.RegisterType((*EnqueueAsyncWorkflowMessageToDLQRequest)(nil), "uber.cadence.history.v1.EnqueueAsyncWorkflowMessageToDLQRequest")
	proto.RegisterType((*EnqueueAsyncWorkflowMessageToDLQResponse)(nil), "uber.cadence.history.v1.EnqueueAsyncWorkflowMessageToDLQResponse")
	proto.RegisterType((*ReadAsyncWorkflowMessagesFromDLQRequest)(nil), "uber.cadence.history.v1.ReadAsyncWorkflowMessagesFromDLQRequest")
	proto.RegisterType((*ReadAsyncWorkflowMessagesFromDLQResponse)(nil), "uber.cadence.history.v1.ReadAsyncWorkflowMessagesFromDLQResponse")
	proto.RegisterType((*MergeAsyncWorkflowMessagesFromDLQRequest)(nil), "uber.cadence.history.v1.MergeAsyncWorkflowMessagesFromDLQRequest")
	proto.RegisterType((*MergeAsyncWorkflowMessagesFromDLQResponse)(nil), "uber.cadence.history.v1.MergeAsyncWorkflowMessagesFromDLQResponse")
	proto.RegisterType((*PurgeAsyncWorkflowMessagesFromDLQRequest)(nil), "uber.cadence.history.v1.PurgeAsyncWorkflowMessagesFromDLQRequest")
	proto.RegisterType((*PurgeAsyncWorkflowMessagesFromDLQResponse)(nil), "uber.cadence.history.v1.PurgeAsyncWorkflowMessagesFromDLQResponse")
}
...
var fileDescriptor_fee8ff76963a38ed = []byte{
	...
	,
}
...
func (m *AsyncWorkflowMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AsyncWorkflowMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AsyncWorkflowMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EnqueueAsyncWorkflowMessageRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.QueueName) > 0 {
		...
		i = encodeVarintService(dAtA, i, uint64(len(m.QueueName)))
		i--
		dAtA[i] = 0x12
	}
	if m.ShardId != 0 {
...
func (m *GetAsyncWorkflowMessagesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetAsyncWorkflowMessagesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetAsyncWorkflowMessagesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.LastMessageId != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.LastMessageId))
		i--
		dAtA[i] = 0x18
	}
	if len(m.QueueName) > 0 {
...
func (m *GetAsyncWorkflowMessagesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetAsyncWorkflowMessagesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetAsyncWorkflowMessagesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.AckLevel != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.AckLevel))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Messages) > 0 {
...
func (m *UpdateAsyncWorkflowAckLevelRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateAsyncWorkflowAckLevelRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateAsyncWorkflowAckLevelRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateAsyncWorkflowAckLevelResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateAsyncWorkflowAckLevelResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateAsyncWorkflowAckLevelResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EnqueueAsyncWorkflowMessageToDLQRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EnqueueAsyncWorkflowMessageToDLQResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReadAsyncWorkflowMessagesFromDLQRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReadAsyncWorkflowMessagesFromDLQResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MergeAsyncWorkflowMessagesFromDLQRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MergeAsyncWorkflowMessagesFromDLQResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.MessagesCount != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.MessagesCount))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AsyncWorkflowMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetAsyncWorkflowMessagesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.LastMessageId != 0 {
		n += 1 + sovService(uint64(m.LastMessageId))
	}
	if m.PageSize != 0 {
		n += 1 + sovService(uint64(m.PageSize))
	}
...
func (m *GetAsyncWorkflowMessagesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.AckLevel != 0 {
		n += 1 + sovService(uint64(m.AckLevel))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *UpdateAsyncWorkflowAckLevelRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateAsyncWorkflowAckLevelResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MessagesCount != 0 {
		n += 1 + sovService(uint64(m.MessagesCount))
	}
	if m.LastMessageId != 0 {
		n += 1 + sovService(uint64(m.LastMessageId))
	}
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AsyncWorkflowMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AsyncWorkflowMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AsyncWorkflowMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GetAsyncWorkflowMessagesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAsyncWorkflowMessagesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAsyncWorkflowMessagesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GetAsyncWorkflowMessagesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAsyncWorkflowMessagesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAsyncWorkflowMessagesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Messages = append(m.Messages, &AsyncWorkflowMessage{})
...
func (m *UpdateAsyncWorkflowAckLevelRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateAsyncWorkflowAckLevelRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateAsyncWorkflowAckLevelRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *UpdateAsyncWorkflowAckLevelResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateAsyncWorkflowAckLevelResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateAsyncWorkflowAckLevelResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *EnqueueAsyncWorkflowMessageToDLQRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnqueueAsyncWorkflowMessageToDLQRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnqueueAsyncWorkflowMessageToDLQRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *EnqueueAsyncWorkflowMessageToDLQResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnqueueAsyncWorkflowMessageToDLQResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnqueueAsyncWorkflowMessageToDLQResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ReadAsyncWorkflowMessagesFromDLQRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadAsyncWorkflowMessagesFromDLQRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadAsyncWorkflowMessagesFromDLQRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ReadAsyncWorkflowMessagesFromDLQResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadAsyncWorkflowMessagesFromDLQResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadAsyncWorkflowMessagesFromDLQResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MergeAsyncWorkflowMessagesFromDLQRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergeAsyncWorkflowMessagesFromDLQRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergeAsyncWorkflowMessagesFromDLQRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *MergeAsyncWorkflowMessagesFromDLQResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergeAsyncWorkflowMessagesFromDLQResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergeAsyncWorkflowMessagesFromDLQResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MessagesCount |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PurgeAsyncWorkflowMessagesFromDLQRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PurgeAsyncWorkflowMessagesFromDLQRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PurgeAsyncWorkflowMessagesFromDLQRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *PurgeAsyncWorkflowMessagesFromDLQResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PurgeAsyncWorkflowMessagesFromDLQResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PurgeAsyncWorkflowMessagesFromDLQResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
