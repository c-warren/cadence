...
type ReplicationTaskInfo struct {
	...
	AsyncWorkflowQueueName    *string `json:"asyncWorkflowQueueName,omitempty"`
	AsyncWorkflowPayload      []byte  `json:"asyncWorkflowPayload,omitempty"`
	AsyncWorkflowEncoding     *string `json:"asyncWorkflowEncoding,omitempty"`
	AsyncWorkflowPartitionKey *string `json:"asyncWorkflowPartitionKey,omitempty"`
}
...
func (v *ReplicationTaskInfo) ToWire() (wire.Value, error) {
	...
	if v.AsyncWorkflowQueueName != nil {
		w, err = wire.NewValueString(*(v.AsyncWorkflowQueueName)), error(nil)
		if err != nil {
			return w, err
		}
		fields[i] = wire.Field{ID: 40, Value: w}
	...
	if v.AsyncWorkflowPayload != nil {
		w, err = wire.NewValueBinary(v.AsyncWorkflowPayload), error(nil)
		if err != nil {
			return w, err
		}
		fields[i] = wire.Field{ID: 42, Value: w}
	...
	if v.AsyncWorkflowEncoding != nil {
		w, err = wire.NewValueString(*(v.AsyncWorkflowEncoding)), error(nil)
		if err != nil {
			return w, err
		}
		fields[i] = wire.Field{ID: 44, Value: w}
	...
	if v.AsyncWorkflowPartitionKey != nil {
		w, err = wire.NewValueString(*(v.AsyncWorkflowPartitionKey)), error(nil)
		if err != nil {
			return w, err
		}
		fields[i] = wire.Field{ID: 46, Value: w}
...
func (v *ReplicationTaskInfo) FromWire(w wire.Value) error {
	...
	for _, field := range w.GetStruct().Fields {
		...
		case 42:
			if field.Value.Type() == wire.TBinary {
				v.AsyncWorkflowPayload, err = field.Value.GetBinary(), error(nil)
				if err != nil {
					return err
				}
...
func (v *ReplicationTaskInfo) Encode(sw stream.Writer) error {
	...
	if v.AsyncWorkflowQueueName != nil {
		...
		if err := sw.WriteString(*(v.AsyncWorkflowQueueName)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.AsyncWorkflowPayload != nil {
		...
		if err := sw.WriteBinary(v.AsyncWorkflowPayload); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.AsyncWorkflowEncoding != nil {
		...
		if err := sw.WriteString(*(v.AsyncWorkflowEncoding)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
	...
	if v.AsyncWorkflowPartitionKey != nil {
		if err := sw.WriteFieldBegin(stream.FieldHeader{ID: 46, Type: wire.TBinary}); err != nil {
			return err
		}
		if err := sw.WriteString(*(v.AsyncWorkflowPartitionKey)); err != nil {
			return err
		}
		if err := sw.WriteFieldEnd(); err != nil {
			return err
...
func (v *ReplicationTaskInfo) Decode(sr stream.Reader) error {
	...
	for ok {
		...
		case fh.ID == 42 && fh.Type == wire.TBinary:
			v.AsyncWorkflowPayload, err = sr.ReadBinary()
			if err != nil {
				return err
			}
		...
		case fh.ID == 46 && fh.Type == wire.TBinary:
			var x string
			x, err = sr.ReadString()
			v.AsyncWorkflowPartitionKey = &x
			if err != nil {
...
func (v *ReplicationTaskInfo) String() string {
	...
	if v.AsyncWorkflowQueueName != nil {
		fields[i] = fmt.Sprintf("AsyncWorkflowQueueName: %v", *(v.AsyncWorkflowQueueName))
		i++
	}
	if v.AsyncWorkflowPayload != nil {
		fields[i] = fmt.Sprintf("AsyncWorkflowPayload: %v", v.AsyncWorkflowPayload)
		i++
	}
	if v.AsyncWorkflowEncoding != nil {
		fields[i] = fmt.Sprintf("AsyncWorkflowEncoding: %v", *(v.AsyncWorkflowEncoding))
		i++
	}
	if v.AsyncWorkflowPartitionKey != nil {
		fields[i] = fmt.Sprintf("AsyncWorkflowPartitionKey: %v", *(v.AsyncWorkflowPartitionKey))
		i++
	}
...
func (v *ReplicationTaskInfo) Equals(rhs *ReplicationTaskInfo) bool {
	...
	if !_String_EqualsPtr(v.AsyncWorkflowQueueName, rhs.AsyncWorkflowQueueName) {
		return false
	}
	if !((v.AsyncWorkflowPayload == nil && rhs.AsyncWorkflowPayload == nil) || (v.AsyncWorkflowPayload != nil && rhs.AsyncWorkflowPayload != nil && bytes.Equal(v.AsyncWorkflowPayload, rhs.AsyncWorkflowPayload))) {
		return false
	}
	if !_String_EqualsPtr(v.AsyncWorkflowEncoding, rhs.AsyncWorkflowEncoding) {
		return false
	}
	if !_String_EqualsPtr(v.AsyncWorkflowPartitionKey, rhs.AsyncWorkflowPartitionKey) {
		return false
	}
...
func (v *ReplicationTaskInfo) MarshalLogObject(enc zapcore.ObjectEncoder) (err error) {
	...
	if v.AsyncWorkflowQueueName != nil {
		enc.AddString("asyncWorkflowQueueName", *v.AsyncWorkflowQueueName)
	}
	if v.AsyncWorkflowPayload != nil {
		enc.AddString("asyncWorkflowPayload", base64.StdEncoding.EncodeToString(v.AsyncWorkflowPayload))
	}
	if v.AsyncWorkflowEncoding != nil {
		enc.AddString("asyncWorkflowEncoding", *v.AsyncWorkflowEncoding)
	}
	if v.AsyncWorkflowPartitionKey != nil {
		enc.AddString("asyncWorkflowPartitionKey", *v.AsyncWorkflowPartitionKey)
	}
	return err
}
...
// GetAsyncWorkflowQueueName returns the value of AsyncWorkflowQueueName if it is set or its
// zero value if it is unset.
func (v *ReplicationTaskInfo) GetAsyncWorkflowQueueName() (o string) {
	if v != nil && v.AsyncWorkflowQueueName != nil {
		return *v.AsyncWorkflowQueueName
	}

	return
}

// IsSetAsyncWorkflowQueueName returns true if AsyncWorkflowQueueName is not nil.
func (v *ReplicationTaskInfo) IsSetAsyncWorkflowQueueName() bool {
	return v != nil && v.AsyncWorkflowQueueName != nil
}

// GetAsyncWorkflowPayload returns the value of AsyncWorkflowPayload if it is set or its
// zero value if it is unset.
func (v *ReplicationTaskInfo) GetAsyncWorkflowPayload() (o []byte) {
	if v != nil && v.AsyncWorkflowPayload != nil {
		return v.AsyncWorkflowPayload
	}

	return
}

// IsSetAsyncWorkflowPayload returns true if AsyncWorkflowPayload is not nil.
func (v *ReplicationTaskInfo) IsSetAsyncWorkflowPayload() bool {
	return v != nil && v.AsyncWorkflowPayload != nil
}

// GetAsyncWorkflowEncoding returns the value of AsyncWorkflowEncoding if it is set or its
// zero value if it is unset.
func (v *ReplicationTaskInfo) GetAsyncWorkflowEncoding() (o string) {
	if v != nil && v.AsyncWorkflowEncoding != nil {
		return *v.AsyncWorkflowEncoding
	}

	return
}

// IsSetAsyncWorkflowEncoding returns true if AsyncWorkflowEncoding is not nil.
func (v *ReplicationTaskInfo) IsSetAsyncWorkflowEncoding() bool {
	return v != nil && v.AsyncWorkflowEncoding != nil
}

// GetAsyncWorkflowPartitionKey returns the value of AsyncWorkflowPartitionKey if it is set or its
// zero value if it is unset.
func (v *ReplicationTaskInfo) GetAsyncWorkflowPartitionKey() (o string) {
	if v != nil && v.AsyncWorkflowPartitionKey != nil {
		return *v.AsyncWorkflowPartitionKey
	}

	return
}

// IsSetAsyncWorkflowPartitionKey returns true if AsyncWorkflowPartitionKey is not nil.
func (v *ReplicationTaskInfo) IsSetAsyncWorkflowPartitionKey() bool {
	return v != nil && v.AsyncWorkflowPartitionKey != nil
}
...
var ThriftModule = &thriftreflect.ThriftModule{
	...
	SHA1:     "1ca99ca2bd5dc3c58553ff1749c2d07a9b18d944",
