...
// CreateAsyncWorkflowReplicationTasks provides a mock function for the type ExecutionManager
func (_mock *ExecutionManager) CreateAsyncWorkflowReplicationTasks(ctx context.Context, request *persistence.CreateAsyncWorkflowReplicationTasksRequest) error {
	ret := _mock.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for CreateAsyncWorkflowReplicationTasks")
	}

	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *persistence.CreateAsyncWorkflowReplicationTasksRequest) error); ok {
		r0 = returnFunc(ctx, request)
	} else {
		r0 = ret.Error(0)
	}
...
// ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateAsyncWorkflowReplicationTasks'
type ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call struct {
	*mock.Call
}

// CreateAsyncWorkflowReplicationTasks is a helper method to define mock.On call
//   - ctx context.Context
//   - request *persistence.CreateAsyncWorkflowReplicationTasksRequest
func (_e *ExecutionManager_Expecter) CreateAsyncWorkflowReplicationTasks(ctx interface{}, request interface{}) *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call {
	return &ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call{Call: _e.mock.On("CreateAsyncWorkflowReplicationTasks", ctx, request)}
}

func (_c *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call) Run(run func(ctx context.Context, request *persistence.CreateAsyncWorkflowReplicationTasksRequest)) *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 *persistence.CreateAsyncWorkflowReplicationTasksRequest
		if args[1] != nil {
			arg1 = args[1].(*persistence.CreateAsyncWorkflowReplicationTasksRequest)
		}
		run(
			arg0,
			arg1,
...
func (_c *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call) Return(err error) *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call) RunAndReturn(run func(ctx context.Context, request *persistence.CreateAsyncWorkflowReplicationTasksRequest) error) *ExecutionManager_CreateAsyncWorkflowReplicationTasks_Call {
	_c.Call.Return(run)
	return _c
}
