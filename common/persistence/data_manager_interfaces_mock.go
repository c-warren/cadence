...
// Source: github.com/uber/cadence/common/persistence (interfaces: Task,ShardManager,ExecutionManager,ExecutionManagerFactory,TaskManager,HistoryManager,DomainManager,DomainAuditManager,HistoryTaskDLQManager,QueueManager,AsyncWorkflowQueueManager,ConfigStoreManager)
//
...
// MockAsyncWorkflowQueueManager is a mock of AsyncWorkflowQueueManager interface.
type MockAsyncWorkflowQueueManager struct {
	ctrl     *gomock.Controller
	recorder *MockAsyncWorkflowQueueManagerMockRecorder
	isgomock struct{}
}

// MockAsyncWorkflowQueueManagerMockRecorder is the mock recorder for MockAsyncWorkflowQueueManager.
type MockAsyncWorkflowQueueManagerMockRecorder struct {
	mock *MockAsyncWorkflowQueueManager
}

// NewMockAsyncWorkflowQueueManager creates a new mock instance.
func NewMockAsyncWorkflowQueueManager(ctrl *gomock.Controller) *MockAsyncWorkflowQueueManager {
	mock := &MockAsyncWorkflowQueueManager{ctrl: ctrl}
	mock.recorder = &MockAsyncWorkflowQueueManagerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAsyncWorkflowQueueManager) EXPECT() *MockAsyncWorkflowQueueManagerMockRecorder {
	return m.recorder
}

// Close mocks base method.
func (m *MockAsyncWorkflowQueueManager) Close() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Close")
}

// Close indicates an expected call of Close.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).Close))
}

// Enqueue mocks base method.
func (m *MockAsyncWorkflowQueueManager) Enqueue(ctx context.Context, request *EnqueueAsyncWorkflowMessageRequest) (*EnqueueAsyncWorkflowMessageResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Enqueue", ctx, request)
	ret0, _ := ret[0].(*EnqueueAsyncWorkflowMessageResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Enqueue indicates an expected call of Enqueue.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) Enqueue(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enqueue", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).Enqueue), ctx, request)
}

// EnqueueToDLQ mocks base method.
func (m *MockAsyncWorkflowQueueManager) EnqueueToDLQ(ctx context.Context, request *EnqueueAsyncWorkflowMessageRequest) (*EnqueueAsyncWorkflowMessageResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnqueueToDLQ", ctx, request)
	ret0, _ := ret[0].(*EnqueueAsyncWorkflowMessageResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// EnqueueToDLQ indicates an expected call of EnqueueToDLQ.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) EnqueueToDLQ(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnqueueToDLQ", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).EnqueueToDLQ), ctx, request)
}

// GetAckLevel mocks base method.
func (m *MockAsyncWorkflowQueueManager) GetAckLevel(ctx context.Context, request *GetAsyncWorkflowAckLevelRequest) (*GetAsyncWorkflowAckLevelResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAckLevel", ctx, request)
	ret0, _ := ret[0].(*GetAsyncWorkflowAckLevelResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAckLevel indicates an expected call of GetAckLevel.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) GetAckLevel(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAckLevel", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).GetAckLevel), ctx, request)
}

// RangeDeleteMessages mocks base method.
func (m *MockAsyncWorkflowQueueManager) RangeDeleteMessages(ctx context.Context, request *RangeDeleteAsyncWorkflowMessagesRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) RangeDeleteMessages(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RangeDeleteMessages", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).RangeDeleteMessages), ctx, request)
}

// RangeDeleteMessagesFromDLQ mocks base method.
func (m *MockAsyncWorkflowQueueManager) RangeDeleteMessagesFromDLQ(ctx context.Context, request *RangeDeleteAsyncWorkflowMessagesRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RangeDeleteMessagesFromDLQ", ctx, request)
	ret0, _ := ret[0].(error)
	return ret0
...
// RangeDeleteMessagesFromDLQ indicates an expected call of RangeDeleteMessagesFromDLQ.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) RangeDeleteMessagesFromDLQ(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RangeDeleteMessagesFromDLQ", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).RangeDeleteMessagesFromDLQ), ctx, request)
}

// ReadMessages mocks base method.
func (m *MockAsyncWorkflowQueueManager) ReadMessages(ctx context.Context, request *ReadAsyncWorkflowMessagesRequest) (*ReadAsyncWorkflowMessagesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadMessages", ctx, request)
	ret0, _ := ret[0].(*ReadAsyncWorkflowMessagesResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReadMessages indicates an expected call of ReadMessages.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) ReadMessages(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadMessages", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).ReadMessages), ctx, request)
}

// ReadMessagesFromDLQ mocks base method.
func (m *MockAsyncWorkflowQueueManager) ReadMessagesFromDLQ(ctx context.Context, request *ReadAsyncWorkflowMessagesRequest) (*ReadAsyncWorkflowMessagesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadMessagesFromDLQ", ctx, request)
	ret0, _ := ret[0].(*ReadAsyncWorkflowMessagesResponse)
	ret1, _ := ret[1].(error)
...
// ReadMessagesFromDLQ indicates an expected call of ReadMessagesFromDLQ.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) ReadMessagesFromDLQ(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadMessagesFromDLQ", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).ReadMessagesFromDLQ), ctx, request)
}

// UpdateAckLevel mocks base method.
func (m *MockAsyncWorkflowQueueManager) UpdateAckLevel(ctx context.Context, request *UpdateAsyncWorkflowAckLevelRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAckLevel", ctx, request)
	ret0, _ := ret[0].(error)
	return ret0
...
// UpdateAckLevel indicates an expected call of UpdateAckLevel.
func (mr *MockAsyncWorkflowQueueManagerMockRecorder) UpdateAckLevel(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAckLevel", reflect.TypeOf((*MockAsyncWorkflowQueueManager)(nil).UpdateAckLevel), ctx, request)
}
